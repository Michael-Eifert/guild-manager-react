...
const TEMPLATES: Record<ChatIntent, string[]> = {
  "lfg-request": [
    ...
    "Who wants to run {mission}? {remaining} spots still open.",
    "{mission} group starting to form. We have {size} of {target}.",
    "Looking for adventurers for {mission}. Need {remaining} more.",
    "Planning a {mission} run. Anyone interested?",
  ],
  join: [
    "I can help with {mission}.",
    "Count me in for {mission}.",
    "I am available. Invite me!",
    "I will come along for {mission}.",
    "Save me a spot for {mission}.",
    "{mission}? I am in.",
    "I can fill a spot. Send the invite.",
  ],
  "role-needed": [
    "Still looking for a {role} for {mission}.",
    "We need one more {role}, then {mission} is ready.",
    "{mission}: any {role} available?",
    "A {role} would complete our {mission} group.",
    "Any {role} interested in joining us for {mission}?",
    "{mission} is waiting on a {role}.",
    "One {role} needed for {mission}, then we can move.",
  ],
  "general-search": [
    ...
    "Calling all adventurers: {mission} needs {remaining} more.",
    "Open spots for {mission}. Group is currently {size}/{target}.",
    "Anyone on the realm up for {mission}? Need {remaining}.",
    "{mission} run looking for more. Whisper for an invite.",
  ],
  "group-ready": [
    "Group is full. Heading to {mission}!",
    "{mission} is ready. Let us move!",
    "That makes {target}/{target}. Starting {mission}.",
    "We have everyone. Meet at {mission}!",
    "Full party for {mission}. Time to get moving.",
    "All roles covered. {mission}, here we come!",
    "{mission} group complete. Let us begin.",
  ],
  "group-start": [
    "Entering {mission}. Good luck everyone!",
    "On our way to {mission}.",
    "{mission} starts now. Stay sharp!",
    "Everyone ready? We are heading into {mission}.",
    "The wait is over. Moving into {mission} now.",
    "Stay together and watch your roles. Starting {mission}.",
    "Doors open. Let us clear {mission}.",
  ],
  "search-expired": [
    ...
    "{mission} is not happening today. Thanks to everyone who tried.",
    "Still short for {mission}, so I am closing the group.",
    "No full party for {mission}. We will regroup later.",
    "Ending the {mission} search. Maybe the next call goes better.",
  ],
  "mission-success": [
...
const PERSONALITY_TEMPLATES: Record<string, Partial<Record<ChatIntent, string[]>>> = {
  dungeon_expert: {
    "lfg-request": [
      ...
      "I can lead {mission} without wasting time. Need {remaining} more.",
      "{mission} is straightforward with the right route. Who is coming?",
    ],
  ...
  power_leveler: {
    "lfg-request": [
      "Quick {mission} run? Need {remaining} more.",
      "Efficient {mission} group forming. {size}/{target}.",
      "No delays, no detours. Who wants a fast {mission}?",
    ],
  ...
  raider: {
    "role-needed": [
      "{mission} still needs a solid {role}. Any volunteers?",
      "We need a prepared {role} to finish the {mission} roster.",
      "{mission} group check: one reliable {role} still needed.",
    ],
  ...
  casual_gamer: {
    "lfg-request": [
      "Anyone fancy a relaxed {mission} run? {size}/{target}.",
      "Casual {mission} run, no rush. Need {remaining} more.",
      "Who wants an easygoing trip through {mission}?",
    ],
