...
const HORDE_LEGACY_MISSIONS = [
  {
    id: "horde:legacy:1",
    type: "quest",
    typeLabel: "Quest",
    name: "Clear Skull Rock",
    zoneId: "durotar",
  ...
  },
  {
    ...
    type: "quest",
    typeLabel: "Quest",
    name: "Secure the Crossroads Roads",
    zoneId: "the_barrens",
    requiredFaction: GUILD_FACTION.HORDE,
    level: 8,
  ...
  },
  {
    ...
    type: "quest",
    typeLabel: "Quest",
    name: "Purge the Tranquillien Crypts",
    zoneId: "ghostlands",
    requiredFaction: GUILD_FACTION.HORDE,
    level: 12,
  ...
  },
  {
    ...
    type: "quest",
    typeLabel: "Elite Quest",
    name: "Elite: Break the Warsong Siege",
    zoneId: "ashenvale",
    requiredFaction: GUILD_FACTION.HORDE,
    level: 14,
  ...
  },
  {
    ...
    type: "quest",
    typeLabel: "Quest",
    name: "Stabilize the Hillsbrad Front",
    zoneId: "hillsbrad_foothills",
    requiredFaction: GUILD_FACTION.HORDE,
    level: 26,
