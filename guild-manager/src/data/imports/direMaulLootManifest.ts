...
export const DIRE_MAUL_ACTIVE_LOOT_MANIFEST = Object.freeze([
  ...
  [18322, "Waterspout Boots", "feet", "Leather", 53, "inv_boots_05", "East", DIRE_MAUL_BOSSES.HYDROSPAWN, { intellect: 12, spirit: 10 }],
  ...
  [18375, "Bracers of the Eclipse", "wrist", "Leather", 58, "inv_bracer_05", "West", DIRE_MAUL_BOSSES.TORTHELDRIN, { agility: 13, stamina: 10 }],
  ...
  [18507, "Boots of the Full Moon", "feet", "Cloth", 57, "inv_boots_07", "North", DIRE_MAUL_BOSSES.KROMCRUSH, { intellect: 13, spirit: 10, stamina: 12 }],
...
export const unsupportedDireMaulDrops = Object.freeze([
  { wowheadId: 18323, name: "Satyr's Bow", unsupportedSlot: "ranged", sourceBosses: [DIRE_MAUL_BOSSES.ZEVRIM] },
  { wowheadId: 18523, name: "Brightly Glowing Stone", unsupportedSlot: "offHand", sourceBosses: [DIRE_MAUL_BOSSES.KING] },
  { wowheadId: 18499, name: "Barrier Shield", unsupportedSlot: "shield", sourceBosses: [DIRE_MAUL_BOSSES.KING] },
]);
